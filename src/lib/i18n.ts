...
const STRINGS = {
  en: {
    ...
    actionToLibrary: "Keep in library",
    ...
    toastToLibrary: "Kept in library",
  ...
  ko: {
    ...
    actionArchive: "아카이브",
    actionToLibrary: "라이브러리에 보관",
    actionToTrash: "휴지통으로",
    actionToInbox: "받은함으로",
    actionRestore: "복원",
    actionDelete: "영구 삭제",
    actionConfirm: "확인",
    toastArchived: "아카이브했습니다",
    toastToLibrary: "라이브러리에 보관했습니다",
